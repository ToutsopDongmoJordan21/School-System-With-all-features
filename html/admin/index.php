                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <h1 class="font-light text-white"><a href="charts.php"><i class="mdi mdi-chart-areaspline"></i></a></h1>
                                <h6 class="text-white">Statistique d'une classe</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><a href="add.php"><i class="mdi mdi-border-inside"></a></i></h1>
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                ...
                                <h6 class="text-white">Faire une inscription</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                ...
                                <h6 class="text-white">Modifier les elements</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                             ...
                                             <div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Nombre de compte</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Total argent recu</small>
                                                </div>
                                            </div>
                                             <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                            ...
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Nombre de classes</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
